    ...
    def __init__(self,
        ...
        for splt in self.split:
            ...
            for ii, line in enumerate(lines):
                ...
                # Edges
                _edge = os.path.join(_edge_gt_dir, line + '.npy') # self.root, 
                assert os.path.isfile(_edge)
                self.edges.append(_edge)

                # Semantic Segmentation
                _semseg = os.path.join(_semseg_gt_dir, line + '.png') # self.root, 
                assert os.path.isfile(_semseg)
                self.semsegs.append(_semseg)

                # Surface Normals
                _normal = os.path.join(_normal_gt_dir, line + '.npy') # self.root, 
                assert os.path.isfile(_normal)
                self.normals.append(_normal)

                # Depth Prediction
                _depth = os.path.join(_depth_gt_dir, line + '.npy') # self.root, 
